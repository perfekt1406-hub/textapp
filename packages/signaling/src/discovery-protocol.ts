/**
 * @fileoverview Shared UDP discovery wire constants for Textapp LAN signaling.
 * @module @textapp/signaling/discovery-protocol
 */
...
export const TEXTAPP_DISCOVER_V1 = "TEXTAPP_DISCOVER_V1\n";

/** Prefix of host reply before JSON metadata line. */
export const TEXTAPP_SIGNALING_V1_PREFIX = "TEXTAPP_SIGNALING_V1\n";
